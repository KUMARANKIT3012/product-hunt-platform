    ...
    <Transition show={visible} as={Fragment}>
      <Dialog onClose={() => setVisible(false)} static={true} open={visible}>
        <Transition.Child
          ...
          leaveTo='opacity-0'
        >
          <div className='fixed inset-0 z-50 transition-opacity bg-black/50 backdrop-blur-sm'></div>
        </Transition.Child>
        ...
        >
          <div className='fixed inset-0 z-50 flex items-center justify-center'>
            <Dialog.Panel className='relative h-full xl:h-[600px] w-full mt-auto sm:mt-0 sm:w-[650px]  flex bg-white k rounded-sm shadow-md'>
